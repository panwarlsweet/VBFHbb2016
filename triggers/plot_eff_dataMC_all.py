...
channel='double'
file_name_end0='_%s_trig%s_afterSecondjetPF80.root'%(channel,trigger)
channel='single'
file_name_end1='_%s_trig%s_afterSecondjetPF80.root'%(channel,trigger)
...
#	func_erf.SetParLimits(2,10,50)
	...
	c.SaveAs("plots_combined/after2jet/plot_%s_%s.png" %(list_hist[num].GetName(),trigger_names[int(trigger)] ))
