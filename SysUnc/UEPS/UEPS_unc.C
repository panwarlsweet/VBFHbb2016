...
//		Float_t cats[10] = {-1.,0.12,0.44,0.57,0.6725};
	...
	Float_t lumi = 35900.;
	Float_t xsec[10] =  {2.20, 25.69,2.2,2.2,2.2,2.2,25.69,25.69};

	const int num_ss = 8;	

	TString s_names[num_ss] = {"VBFHbb","ggHbb","VBFHbb_herwig","VBFHbb_CUEDown","VBFHbb_CUEUp","VBFHbb_amc","ggHbb_herwig","ggHbb_amc"};
