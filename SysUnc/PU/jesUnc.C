...
//	TString type_unc = "JES";
	TString type_unc = "JER";
...
//	sprintf(cmd2,"(\%sPassSelection_nom==1)*(\%strigWeight_nom*puWeight*Jet_btagWeightCMVAV2[\%sbtag_num1]*Jet_btagWeightCMVAV2[\%sbtag_num2]*\%sQGLweight)",(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()));	
	...
	sprintf(cmd2,"((\%sPassSelection_nom==1)&& (Vtype==-1||Vtype>3)&& (\%sMbb>=80) && (\%sMbb<=200))*(\%strigWeight_nom*puWeight*TMath::Abs(genWeight)/genWeight)",(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()));	
//	sprintf(cmd2,"((\%sPassSelection_nom==1)&& (Vtype==-1||Vtype>3))*(puWeight*TMath::Abs(genWeight)/genWeight)",(type.c_str()));	
...
//	tree_bdt_JEnom->Draw(cmd3,cmd2);
	...
	sprintf(cmd,"\%s\%s>>\%s",(type.c_str()),("VBF_bdt_JER_down"),("hist_bdt_down"));	
...
//	sprintf(cmd2,"((\%sPassSelection_JES_down==1)&& (Vtype==-1||Vtype>3))*(\%strigWeight_nom*puWeight*Jet_btagWeightCMVAV2[\%sbtag_num1]*Jet_btagWeightCMVAV2[\%sbtag_num2]*\%sQGLweight*TMath::Abs(genWeight)/genWeight)",(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()));	
	sprintf(cmd2,"((\%sPassSelection_JER_down==1)&& (Vtype==-1||Vtype>3)&& (\%sMbb_JER_down>=80) && (\%sMbb_JER_down<=200))*(\%strigWeight_JER_down*puWeight*TMath::Abs(genWeight)/genWeight)",(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()));	
//	sprintf(cmd2,"((\%sPassSelection_JES_down==1)&& (Vtype==-1||Vtype>3))*(puWeight*TMath::Abs(genWeight)/genWeight)",(type.c_str()));	
...
//	tree_bdt_JEnom->Draw(cmd3,cmd2);
	...
	sprintf(cmd,"\%s\%s>>\%s",(type.c_str()),("VBF_bdt_JER_up"),("hist_bdt_up"));	
//	sprintf(cmd3,"\%s\%s>>\%s",(type),("Mbb"),("hist_mbb_up"));	
//	sprintf(cmd2,"((\%sPassSelection_JES_up==1)&& (Vtype==-1||Vtype>3))*(\%strigWeight_nom*puWeight*Jet_btagWeightCMVAV2[\%sbtag_num1]*Jet_btagWeightCMVAV2[\%sbtag_num2]*\%sQGLweight*TMath::Abs(genWeight)/genWeight)",(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()));	
	sprintf(cmd2,"((\%sPassSelection_JER_up==1)&& (Vtype==-1||Vtype>3)&& (\%sMbb_JER_up>=80) && (\%sMbb_JER_up<=200))*(\%strigWeight_JES_up*puWeight*TMath::Abs(genWeight)/genWeight)",(type.c_str()),(type.c_str()),(type.c_str()),(type.c_str()));	
//	sprintf(cmd2,"((\%sPassSelection_JES_up==1)&& (Vtype==-1||Vtype>3))*(puWeight*TMath::Abs(genWeight)/genWeight)",(type.c_str()));	
