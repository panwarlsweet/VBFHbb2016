...
//	file_names[i].Append("_trignone_v25_VBF_newReg");
	file_names[i].Append("_trignone_v25_trigWeightNewRegBtagCut_ZbbBdtIncl");  //Zbb
...
TString dir_name="Thesis/plots_v25_VBFbdtRegZbb";
...
for (int i=0;i<nhistos;i++){
	...
	output_names[i].Append(set[set_type]+"_v25.pdf");
}
...
tex->SetLineWidth(2);
TLatex *tex1 = new TLatex(0.19,0.95,"CMS");
tex1->SetNDC();
tex1->SetTextAlign(20);
tex1->SetTextFont(61);
tex1->SetTextSize(0.04);
tex1->SetLineWidth(2);
TLatex* tex2 = new TLatex(0.28,0.89,"Work in progress");
tex2->SetNDC();
