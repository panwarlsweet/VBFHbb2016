...
for (int i=0;i<nfiles;i++){
   file_names[i].Prepend("dcap://t3se01.psi.ch:22125//pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFHbb2016/plotterOutput/v25/");
	...
	if (i==0)file_names[i].Append("_trignone_v25_VBF_newReg_turnOn_onlyH");
	if (i!=0)file_names[i].Append("_trignone_v25_VBF_newReg_turnOn");
...
TString dir_name="runH/plots_v25_runH";
...
TLatex* tex = new TLatex(0.75,0.95,"8.86 fb^{-1}, Run H (13 TeV)");
tex->SetNDC();
tex->SetTextAlign(35);
tex->SetTextFont(42);
