...
//	file_names[i].Append("_trignone_v25_VBF_newReg");//Hbb
...
TString dir_name= "PAS/Zbb/plots_v25_trigWeightNewRegBtagCutIncl";
//TString dir_name="PAS/plots_v25_VBFbdtReg";
