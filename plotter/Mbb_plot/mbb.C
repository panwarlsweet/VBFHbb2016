...
RooWorkspace w("w","workspace");
	...
	TFile *file_down =  TFile::Open("dcap://t3se01.psi.ch:22125//pnfs/psi.ch/cms/trivcat/store/user/nchernya/VBFHbb2016/plotterOutput/v25/VBFHToBB_M-125_analysis"+type+"_trignone_v25_trigWeightNewReg.root");
	TH1F *hist_mbb_reg= (TH1F*)file_down->Get("hMbb_regVBF_fsr");
	hist_mbb_reg->Scale(1./hist_mbb_reg->Integral());	
	TH1F *hist_mbb= (TH1F*)file_down->Get("hMbb");
...
//workspaces
	...
	TString tmp;
	RooRealVar m("mean_reg","mean_reg",124,115,135);
	RooRealVar s("sigma_reg","sigma_reg",12,7,20);
	RooRealVar a("alpha_reg","alpha_reg",1,-5,5);
...
char nVar2[50], xVar2[50];
	...
	RooRealVar m2("mean","mean",116,100,120);
	RooRealVar s2("sigma","sigma",15,7,20);
...
//////////////////////////////////////
 /// Draw 
	...
	leg->AddEntry(hist_mbb_reg,"Regressed + FSR","PL");
...
// CMS info
	...
	c_roo->Print("plots/mbb_reg_v25"+type+".pdf");
