...
RooWorkspace w("w","workspace");
	...
	TFile *file_down =  TFile::Open(path+"BTagCSV_analysis"+type+"_trignone_v25_trigWeightNewRegBtagCut_ZbbBdtIncl.root");
//	TProfile *hist_mbb_reg= (TProfile*)file_down->Get("hprof_Zbb_range");
	TProfile *hist_mbb_reg= (TProfile*)file_down->Get("hprof_Zbb");
...
/////////
	...
	TFile *file_qcd =  TFile::Open(path+"QCD_analysis"+type+"_trignone_v25_trigWeightNewRegBtagCut_ZbbBdtIncl.root");
//	TProfile *hist_mbb_reg_qcd= (TProfile*)file_qcd->Get("hprof_Zbb_range");
	TProfile *hist_mbb_reg_qcd= (TProfile*)file_qcd->Get("hprof_Zbb");
...
//	c_roo->Print("plots/profile_mbb_range"+type+".pdf");
	c_roo->Print("plots/profile_mbb"+type+".pdf");
