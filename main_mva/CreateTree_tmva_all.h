...
public :
 ...
 TBranch        *b_run;   //!
   ...
   CreateTree_tmva_all(TString filename="");
   virtual ~CreateTree_tmva_all();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TString filename);
   virtual void     Loop(TString output="",int data=0,int set_type=0 );
...
CreateTree_tmva_all::CreateTree_tmva_all(TString filename) : fChain(0) 
{
...
void CreateTree_tmva_all::AddFile(TString filename)
{
	file_name = filename;
...
void CreateTree_tmva_all::Init(TString filename)
{
