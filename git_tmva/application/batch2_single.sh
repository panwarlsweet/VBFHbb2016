...
./run_all_1 $1 $TMPDIR/$2 $3 


echo $1 $TMPDIR/$2 $3 


xrdfs t3dcachedb03.psi.ch rm /pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFHbb2016/v25_VBF_mva_JESR_full/$2$root

xrdcp -f $TMPDIR/$2$root root://t3dcachedb.psi.ch:1094//pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFHbb2016/v25_VBF_mva_JESR_full/
