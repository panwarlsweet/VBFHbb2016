...
// Wed Sep 14 13:48:00 2016 by ROOT version 5.34/18
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: tree_v24.root
//////////////////////////////////////////////////////////

#ifndef CreateTree_Zbb_h
#define CreateTree_Zbb_h
...
public :
 ...
 UInt_t          run;
   ...
   Int_t           GenLepFromTop_isPromptHard[1];   //[nGenLepFromTop]
   ...
   Int_t           GenBQuarkFromTop_isPromptHard[1];   //[nGenBQuarkFromTop]
   ...
   Int_t           GenNuFromTop_isPromptHard[1];   //[nGenNuFromTop]
   Int_t           nGenBQuarkFromHafterISR;
   Int_t           GenBQuarkFromHafterISR_pdgId[4];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_pt[4];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_eta[4];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_phi[4];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_mass[4];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_charge[4];   //[nGenBQuarkFromHafterISR]
   Int_t           GenBQuarkFromHafterISR_status[4];   //[nGenBQuarkFromHafterISR]
   Int_t           GenBQuarkFromHafterISR_isPromptHard[4];   //[nGenBQuarkFromHafterISR]
   ...
   Int_t           nGenNu;
   Float_t         GenNu_charge[1];   //[nGenNu]
   Int_t           GenNu_status[1];   //[nGenNu]
   Int_t           GenNu_isPromptHard[1];   //[nGenNu]
   Int_t           GenNu_pdgId[1];   //[nGenNu]
   Float_t         GenNu_pt[1];   //[nGenNu]
   Float_t         GenNu_eta[1];   //[nGenNu]
   Float_t         GenNu_phi[1];   //[nGenNu]
   Float_t         GenNu_mass[1];   //[nGenNu]
   Int_t           GenNu_motherId[1];   //[nGenNu]
   Int_t           GenNu_grandmotherId[1];   //[nGenNu]
   Int_t           GenNu_sourceId[1];   //[nGenNu]
   ...
   Float_t         GenLepRecovered_eta[2];   //[nGenLepRecovered]
   Float_t         GenLepRecovered_phi[2];   //[nGenLepRecovered]
   Float_t         GenLepRecovered_mass[2];   //[nGenLepRecovered]
   Float_t         GenLepRecovered_charge[2];   //[nGenLepRecovered]
   ...
   Int_t           GenVbosonsRecovered_pdgId[3];   //[nGenVbosonsRecovered]
   Float_t         GenVbosonsRecovered_pt[3];   //[nGenVbosonsRecovered]
   Float_t         GenVbosonsRecovered_eta[3];   //[nGenVbosonsRecovered]
   Float_t         GenVbosonsRecovered_phi[3];   //[nGenVbosonsRecovered]
   Float_t         GenVbosonsRecovered_mass[3];   //[nGenVbosonsRecovered]
   Float_t         GenVbosonsRecovered_charge[3];   //[nGenVbosonsRecovered]
   Int_t           GenVbosonsRecovered_status[3];   //[nGenVbosonsRecovered]
   Int_t           GenVbosonsRecovered_isPromptHard[3];   //[nGenVbosonsRecovered]
   ...
   Int_t           nvLeptons;
   Int_t           vLeptons_charge[10];   //[nvLeptons]
   Int_t           vLeptons_tightId[10];   //[nvLeptons]
   Int_t           vLeptons_eleCutIdCSA14_25ns_v1[10];   //[nvLeptons]
   Int_t           vLeptons_eleCutIdCSA14_50ns_v1[10];   //[nvLeptons]
   Int_t           vLeptons_eleCutIdSpring15_25ns_v1[10];   //[nvLeptons]
   Int_t           vLeptons_mediumIdPOG_ICHEP2016[10];   //[nvLeptons]
   Float_t         vLeptons_dxy[10];   //[nvLeptons]
   Float_t         vLeptons_dz[10];   //[nvLeptons]
   Float_t         vLeptons_edxy[10];   //[nvLeptons]
   Float_t         vLeptons_edz[10];   //[nvLeptons]
   Float_t         vLeptons_ip3d[10];   //[nvLeptons]
   Float_t         vLeptons_sip3d[10];   //[nvLeptons]
   Int_t           vLeptons_convVeto[10];   //[nvLeptons]
   Int_t           vLeptons_lostHits[10];   //[nvLeptons]
   Float_t         vLeptons_relIso03[10];   //[nvLeptons]
   Float_t         vLeptons_relIso04[10];   //[nvLeptons]
   Float_t         vLeptons_miniRelIso[10];   //[nvLeptons]
   Float_t         vLeptons_relIsoAn04[10];   //[nvLeptons]
   Int_t           vLeptons_tightCharge[10];   //[nvLeptons]
   Int_t           vLeptons_mcMatchId[10];   //[nvLeptons]
   Int_t           vLeptons_mcMatchAny[10];   //[nvLeptons]
   Int_t           vLeptons_mcMatchTau[10];   //[nvLeptons]
   Float_t         vLeptons_mcPt[10];   //[nvLeptons]
   Int_t           vLeptons_mediumMuonId[10];   //[nvLeptons]
   Int_t           vLeptons_pdgId[10];   //[nvLeptons]
   Float_t         vLeptons_pt[10];   //[nvLeptons]
   Float_t         vLeptons_eta[10];   //[nvLeptons]
   Float_t         vLeptons_phi[10];   //[nvLeptons]
   Float_t         vLeptons_mass[10];   //[nvLeptons]
   Int_t           vLeptons_looseIdSusy[10];   //[nvLeptons]
   Int_t           vLeptons_looseIdPOG[10];   //[nvLeptons]
   Float_t         vLeptons_chargedHadRelIso03[10];   //[nvLeptons]
   Float_t         vLeptons_chargedHadRelIso04[10];   //[nvLeptons]
   Float_t         vLeptons_eleSieie[10];   //[nvLeptons]
   Float_t         vLeptons_eleDEta[10];   //[nvLeptons]
   Float_t         vLeptons_eleDPhi[10];   //[nvLeptons]
   Float_t         vLeptons_eleHoE[10];   //[nvLeptons]
   Float_t         vLeptons_eleMissingHits[10];   //[nvLeptons]
   Float_t         vLeptons_eleChi2[10];   //[nvLeptons]
   Int_t           vLeptons_convVetoFull[10];   //[nvLeptons]
   Float_t         vLeptons_eleMVArawSpring15Trig[10];   //[nvLeptons]
   Int_t           vLeptons_eleMVAIdSpring15Trig[10];   //[nvLeptons]
   Float_t         vLeptons_eleMVArawSpring15NonTrig[10];   //[nvLeptons]
   Int_t           vLeptons_eleMVAIdSpring15NonTrig[10];   //[nvLeptons]
   Float_t         vLeptons_eleMVArawSpring16GenPurp[10];   //[nvLeptons]
   Int_t           vLeptons_eleMVAIdSppring16GenPurp[10];   //[nvLeptons]
   Float_t         vLeptons_nStations[10];   //[nvLeptons]
   Float_t         vLeptons_trkKink[10];   //[nvLeptons]
   Float_t         vLeptons_segmentCompatibility[10];   //[nvLeptons]
   Float_t         vLeptons_caloCompatibility[10];   //[nvLeptons]
   Float_t         vLeptons_globalTrackChi2[10];   //[nvLeptons]
   Float_t         vLeptons_nChamberHits[10];   //[nvLeptons]
   Float_t         vLeptons_isPFMuon[10];   //[nvLeptons]
   Float_t         vLeptons_isGlobalMuon[10];   //[nvLeptons]
   Float_t         vLeptons_isTrackerMuon[10];   //[nvLeptons]
   Float_t         vLeptons_pixelHits[10];   //[nvLeptons]
   Int_t           vLeptons_trackerLayers[10];   //[nvLeptons]
   Int_t           vLeptons_pixelLayers[10];   //[nvLeptons]
   Float_t         vLeptons_mvaTTH[10];   //[nvLeptons]
   Int_t           vLeptons_jetOverlapIdx[10];   //[nvLeptons]
   Float_t         vLeptons_jetPtRatio[10];   //[nvLeptons]
   Float_t         vLeptons_jetBTagCSV[10];   //[nvLeptons]
   Float_t         vLeptons_jetDR[10];   //[nvLeptons]
   Float_t         vLeptons_mvaTTHjetPtRatio[10];   //[nvLeptons]
   Float_t         vLeptons_mvaTTHjetBTagCSV[10];   //[nvLeptons]
   Float_t         vLeptons_mvaTTHjetDR[10];   //[nvLeptons]
   Float_t         vLeptons_pfRelIso03[10];   //[nvLeptons]
   Float_t         vLeptons_pfRelIso04[10];   //[nvLeptons]
   Float_t         vLeptons_etaSc[10];   //[nvLeptons]
   Float_t         vLeptons_eleExpMissingInnerHits[10];   //[nvLeptons]
   Float_t         vLeptons_eleooEmooP[10];   //[nvLeptons]
   Float_t         vLeptons_dr03TkSumPt[10];   //[nvLeptons]
   Float_t         vLeptons_eleEcalClusterIso[10];   //[nvLeptons]
   Float_t         vLeptons_eleHcalClusterIso[10];   //[nvLeptons]
   Float_t         vLeptons_miniIsoCharged[10];   //[nvLeptons]
   Float_t         vLeptons_miniIsoNeutral[10];   //[nvLeptons]
   Float_t         vLeptons_mvaTTHjetPtRel[10];   //[nvLeptons]
   Float_t         vLeptons_mvaTTHjetNDauChargedMVASel[10];   //[nvLeptons]
   Float_t         vLeptons_uncalibratedPt[10];   //[nvLeptons]
   Float_t         vLeptons_SF_IsoLoose[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IsoLoose[10];   //[nvLeptons]
   Float_t         vLeptons_SF_IsoTight[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IsoTight[10];   //[nvLeptons]
   Float_t         vLeptons_SF_IdCutLoose[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IdCutLoose[10];   //[nvLeptons]
   Float_t         vLeptons_SF_IdCutTight[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IdCutTight[10];   //[nvLeptons]
   Float_t         vLeptons_SF_IdMVALoose[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IdMVALoose[10];   //[nvLeptons]
   Float_t         vLeptons_SF_IdMVATight[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IdMVATight[10];   //[nvLeptons]
   Float_t         vLeptons_SF_HLT_RunD4p3[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_HLT_RunD4p3[10];   //[nvLeptons]
   Float_t         vLeptons_SF_HLT_RunD4p2[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_HLT_RunD4p2[10];   //[nvLeptons]
   Float_t         vLeptons_SF_HLT_RunC[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_HLT_RunC[10];   //[nvLeptons]
   Float_t         vLeptons_SF_trk_eta[10];   //[nvLeptons]
   Float_t         vLeptons_SFerr_trk_eta[10];   //[nvLeptons]
   Float_t         vLeptons_Eff_HLT_RunD4p3[10];   //[nvLeptons]
   Float_t         vLeptons_Efferr_HLT_RunD4p3[10];   //[nvLeptons]
   Float_t         vLeptons_Eff_HLT_RunD4p2[10];   //[nvLeptons]
   Float_t         vLeptons_Efferr_HLT_RunD4p2[10];   //[nvLeptons]
   Float_t         vLeptons_Eff_HLT_RunC[10];   //[nvLeptons]
   Float_t         vLeptons_Efferr_HLT_RunC[10];   //[nvLeptons]
   ...
   Int_t           GenBQuarkFromH_isPromptHard[4];   //[nGenBQuarkFromH]
   ...
   Int_t           aLeptons_mediumIdPOG_ICHEP2016[5];   //[naLeptons]
   ...
   Float_t         aLeptons_relIsoAn04[5];   //[naLeptons]
   ...
   Int_t           aLeptons_convVetoFull[5];   //[naLeptons]
   Float_t         aLeptons_eleMVArawSpring15Trig[5];   //[naLeptons]
   ...
   Float_t         aLeptons_mvaTTHjetPtRatio[5];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetBTagCSV[5];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetDR[5];   //[naLeptons]
   ...
   Float_t         aLeptons_dr03TkSumPt[5];   //[naLeptons]
   Float_t         aLeptons_eleEcalClusterIso[5];   //[naLeptons]
   Float_t         aLeptons_eleHcalClusterIso[5];   //[naLeptons]
   Float_t         aLeptons_miniIsoCharged[5];   //[naLeptons]
   Float_t         aLeptons_miniIsoNeutral[5];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetPtRel[5];   //[naLeptons]
   Float_t         aLeptons_mvaTTHjetNDauChargedMVASel[5];   //[naLeptons]
   Float_t         aLeptons_uncalibratedPt[5];   //[naLeptons]
   Float_t         aLeptons_SF_IsoLoose[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_IsoLoose[5];   //[naLeptons]
   Float_t         aLeptons_SF_IsoTight[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_IsoTight[5];   //[naLeptons]
   Float_t         aLeptons_SF_IdCutLoose[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdCutLoose[5];   //[naLeptons]
   Float_t         aLeptons_SF_IdCutTight[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdCutTight[5];   //[naLeptons]
   Float_t         aLeptons_SF_IdMVALoose[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdMVALoose[5];   //[naLeptons]
   Float_t         aLeptons_SF_IdMVATight[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdMVATight[5];   //[naLeptons]
   Float_t         aLeptons_SF_HLT_RunD4p3[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_HLT_RunD4p3[5];   //[naLeptons]
   Float_t         aLeptons_SF_HLT_RunD4p2[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_HLT_RunD4p2[5];   //[naLeptons]
   Float_t         aLeptons_SF_HLT_RunC[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_HLT_RunC[5];   //[naLeptons]
   Float_t         aLeptons_SF_trk_eta[5];   //[naLeptons]
   Float_t         aLeptons_SFerr_trk_eta[5];   //[naLeptons]
   Float_t         aLeptons_Eff_HLT_RunD4p3[5];   //[naLeptons]
   Float_t         aLeptons_Efferr_HLT_RunD4p3[5];   //[naLeptons]
   Float_t         aLeptons_Eff_HLT_RunD4p2[5];   //[naLeptons]
   ...
   Int_t           GenHiggsSisters_isPromptHard[4];   //[nGenHiggsSisters]
   ...
   Int_t           nselLeptons;
   Int_t           selLeptons_charge[10];   //[nselLeptons]
   Int_t           selLeptons_tightId[10];   //[nselLeptons]
   Int_t           selLeptons_eleCutIdCSA14_25ns_v1[10];   //[nselLeptons]
   Int_t           selLeptons_eleCutIdCSA14_50ns_v1[10];   //[nselLeptons]
   Int_t           selLeptons_eleCutIdSpring15_25ns_v1[10];   //[nselLeptons]
   Int_t           selLeptons_mediumIdPOG_ICHEP2016[10];   //[nselLeptons]
   Float_t         selLeptons_dxy[10];   //[nselLeptons]
   Float_t         selLeptons_dz[10];   //[nselLeptons]
   Float_t         selLeptons_edxy[10];   //[nselLeptons]
   Float_t         selLeptons_edz[10];   //[nselLeptons]
   Float_t         selLeptons_ip3d[10];   //[nselLeptons]
   Float_t         selLeptons_sip3d[10];   //[nselLeptons]
   Int_t           selLeptons_convVeto[10];   //[nselLeptons]
   Int_t           selLeptons_lostHits[10];   //[nselLeptons]
   Float_t         selLeptons_relIso03[10];   //[nselLeptons]
   Float_t         selLeptons_relIso04[10];   //[nselLeptons]
   Float_t         selLeptons_miniRelIso[10];   //[nselLeptons]
   Float_t         selLeptons_relIsoAn04[10];   //[nselLeptons]
   Int_t           selLeptons_tightCharge[10];   //[nselLeptons]
   Int_t           selLeptons_mcMatchId[10];   //[nselLeptons]
   Int_t           selLeptons_mcMatchAny[10];   //[nselLeptons]
   Int_t           selLeptons_mcMatchTau[10];   //[nselLeptons]
   Float_t         selLeptons_mcPt[10];   //[nselLeptons]
   Int_t           selLeptons_mediumMuonId[10];   //[nselLeptons]
   Int_t           selLeptons_pdgId[10];   //[nselLeptons]
   Float_t         selLeptons_pt[10];   //[nselLeptons]
   Float_t         selLeptons_eta[10];   //[nselLeptons]
   Float_t         selLeptons_phi[10];   //[nselLeptons]
   Float_t         selLeptons_mass[10];   //[nselLeptons]
   Int_t           selLeptons_looseIdSusy[10];   //[nselLeptons]
   Int_t           selLeptons_looseIdPOG[10];   //[nselLeptons]
   Float_t         selLeptons_chargedHadRelIso03[10];   //[nselLeptons]
   Float_t         selLeptons_chargedHadRelIso04[10];   //[nselLeptons]
   Float_t         selLeptons_eleSieie[10];   //[nselLeptons]
   Float_t         selLeptons_eleDEta[10];   //[nselLeptons]
   Float_t         selLeptons_eleDPhi[10];   //[nselLeptons]
   Float_t         selLeptons_eleHoE[10];   //[nselLeptons]
   Float_t         selLeptons_eleMissingHits[10];   //[nselLeptons]
   Float_t         selLeptons_eleChi2[10];   //[nselLeptons]
   Int_t           selLeptons_convVetoFull[10];   //[nselLeptons]
   Float_t         selLeptons_eleMVArawSpring15Trig[10];   //[nselLeptons]
   Int_t           selLeptons_eleMVAIdSpring15Trig[10];   //[nselLeptons]
   Float_t         selLeptons_eleMVArawSpring15NonTrig[10];   //[nselLeptons]
   Int_t           selLeptons_eleMVAIdSpring15NonTrig[10];   //[nselLeptons]
   Float_t         selLeptons_eleMVArawSpring16GenPurp[10];   //[nselLeptons]
   Int_t           selLeptons_eleMVAIdSppring16GenPurp[10];   //[nselLeptons]
   Float_t         selLeptons_nStations[10];   //[nselLeptons]
   Float_t         selLeptons_trkKink[10];   //[nselLeptons]
   Float_t         selLeptons_segmentCompatibility[10];   //[nselLeptons]
   Float_t         selLeptons_caloCompatibility[10];   //[nselLeptons]
   Float_t         selLeptons_globalTrackChi2[10];   //[nselLeptons]
   Float_t         selLeptons_nChamberHits[10];   //[nselLeptons]
   Float_t         selLeptons_isPFMuon[10];   //[nselLeptons]
   Float_t         selLeptons_isGlobalMuon[10];   //[nselLeptons]
   Float_t         selLeptons_isTrackerMuon[10];   //[nselLeptons]
   Float_t         selLeptons_pixelHits[10];   //[nselLeptons]
   Int_t           selLeptons_trackerLayers[10];   //[nselLeptons]
   Int_t           selLeptons_pixelLayers[10];   //[nselLeptons]
   Float_t         selLeptons_mvaTTH[10];   //[nselLeptons]
   Int_t           selLeptons_jetOverlapIdx[10];   //[nselLeptons]
   Float_t         selLeptons_jetPtRatio[10];   //[nselLeptons]
   Float_t         selLeptons_jetBTagCSV[10];   //[nselLeptons]
   Float_t         selLeptons_jetDR[10];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetPtRatio[10];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetBTagCSV[10];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetDR[10];   //[nselLeptons]
   Float_t         selLeptons_pfRelIso03[10];   //[nselLeptons]
   Float_t         selLeptons_pfRelIso04[10];   //[nselLeptons]
   Float_t         selLeptons_etaSc[10];   //[nselLeptons]
   Float_t         selLeptons_eleExpMissingInnerHits[10];   //[nselLeptons]
   Float_t         selLeptons_eleooEmooP[10];   //[nselLeptons]
   Float_t         selLeptons_dr03TkSumPt[10];   //[nselLeptons]
   Float_t         selLeptons_eleEcalClusterIso[10];   //[nselLeptons]
   Float_t         selLeptons_eleHcalClusterIso[10];   //[nselLeptons]
   Float_t         selLeptons_miniIsoCharged[10];   //[nselLeptons]
   Float_t         selLeptons_miniIsoNeutral[10];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetPtRel[10];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetNDauChargedMVASel[10];   //[nselLeptons]
   Float_t         selLeptons_uncalibratedPt[10];   //[nselLeptons]
   Float_t         selLeptons_SF_IsoLoose[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IsoLoose[10];   //[nselLeptons]
   Float_t         selLeptons_SF_IsoTight[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IsoTight[10];   //[nselLeptons]
   Float_t         selLeptons_SF_IdCutLoose[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdCutLoose[10];   //[nselLeptons]
   Float_t         selLeptons_SF_IdCutTight[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdCutTight[10];   //[nselLeptons]
   Float_t         selLeptons_SF_IdMVALoose[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdMVALoose[10];   //[nselLeptons]
   Float_t         selLeptons_SF_IdMVATight[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdMVATight[10];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunD4p3[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunD4p3[10];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunD4p2[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunD4p2[10];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunC[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunC[10];   //[nselLeptons]
   Float_t         selLeptons_SF_trk_eta[10];   //[nselLeptons]
   Float_t         selLeptons_SFerr_trk_eta[10];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunD4p3[10];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunD4p3[10];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunD4p2[10];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunD4p2[10];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunC[10];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunC[10];   //[nselLeptons]
   ...
   Float_t         Jet_rawPtAfterSmearing[25];   //[nJet]
   Int_t           Jet_idxFirstTauMatch[25];   //[nJet]
   Int_t           Jet_heppyFlavour[25];   //[nJet]
   Float_t         Jet_ctagVsL[25];   //[nJet]
   Float_t         Jet_ctagVsB[25];   //[nJet]
   ...
   Float_t         Jet_btagDeepCSVdusg[25];   //[nJet]
   Float_t         Jet_btagDeepCSVb[25];   //[nJet]
   Float_t         Jet_btagDeepCSVc[25];   //[nJet]
   Float_t         Jet_btagDeepCSVbb[25];   //[nJet]
   Float_t         Jet_btagDeepCMVAdusg[25];   //[nJet]
   Float_t         Jet_btagDeepCMVAb[25];   //[nJet]
   Float_t         Jet_btagDeepCMVAc[25];   //[nJet]
   Float_t         Jet_btagDeepCMVAbb[25];   //[nJet]
   ...
   Int_t           Jet_btagCmvaIdx[25];   //[nJet]
   Int_t           Jet_mcIdx[25];   //[nJet]
   Float_t         Jet_blike_VBF[25];   //[nJet]
   Float_t         Jet_pt_puppi[25];   //[nJet]
   Float_t         Jet_pt_reg[25];   //[nJet]
   Float_t         Jet_pt_regVBF[25];   //[nJet]
   Float_t         Jet_pt_reg_corrJECUp[25];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJECUp[25];   //[nJet]
   Float_t         Jet_pt_reg_corrJECDown[25];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJECDown[25];   //[nJet]
   Float_t         Jet_pt_reg_corrJERUp[25];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJERUp[25];   //[nJet]
   Float_t         Jet_pt_reg_corrJERDown[25];   //[nJet]
   Float_t         Jet_pt_regVBF_corrJERDown[25];   //[nJet]
   Float_t         Jet_btagCSVL_SF[25];   //[nJet]
   Float_t         Jet_btagCSVL_SF_up[25];   //[nJet]
   Float_t         Jet_btagCSVL_SF_down[25];   //[nJet]
   Float_t         Jet_btagCSVM_SF[25];   //[nJet]
   Float_t         Jet_btagCSVM_SF_up[25];   //[nJet]
   Float_t         Jet_btagCSVM_SF_down[25];   //[nJet]
   Float_t         Jet_btagCSVT_SF[25];   //[nJet]
   Float_t         Jet_btagCSVT_SF_up[25];   //[nJet]
   Float_t         Jet_btagCSVT_SF_down[25];   //[nJet]
   Float_t         Jet_btagWeightCSV[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_jes[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_jes[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_lf[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_lf[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_hf[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_hf[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_hfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_hfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_hfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_hfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_lfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_lfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_lfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_lfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_cferr1[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_cferr1[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_up_cferr2[25];   //[nJet]
   Float_t         Jet_btagWeightCSV_down_cferr2[25];   //[nJet]
   Float_t         Jet_btagCMVAV2L_SF[25];   //[nJet]
   Float_t         Jet_btagCMVAV2L_SF_up[25];   //[nJet]
   Float_t         Jet_btagCMVAV2L_SF_down[25];   //[nJet]
   Float_t         Jet_btagCMVAV2M_SF[25];   //[nJet]
   Float_t         Jet_btagCMVAV2M_SF_up[25];   //[nJet]
   Float_t         Jet_btagCMVAV2M_SF_down[25];   //[nJet]
   Float_t         Jet_btagCMVAV2T_SF[25];   //[nJet]
   Float_t         Jet_btagCMVAV2T_SF_up[25];   //[nJet]
   Float_t         Jet_btagCMVAV2T_SF_down[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_jes[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_jes[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_lf[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_lf[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_hf[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_hf[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_hfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_hfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_hfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_hfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_lfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_lfstats1[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_lfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_lfstats2[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_cferr1[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_cferr1[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_up_cferr2[25];   //[nJet]
   Float_t         Jet_btagWeightCMVAV2_down_cferr2[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteStatUp[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteStatDown[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteScaleUp[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteScaleDown[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteFlavMapUp[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteFlavMapDown[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteMPFBiasUp[25];   //[nJet]
   Float_t         Jet_corr_AbsoluteMPFBiasDown[25];   //[nJet]
   Float_t         Jet_corr_FragmentationUp[25];   //[nJet]
   Float_t         Jet_corr_FragmentationDown[25];   //[nJet]
   Float_t         Jet_corr_SinglePionECALUp[25];   //[nJet]
   Float_t         Jet_corr_SinglePionECALDown[25];   //[nJet]
   Float_t         Jet_corr_SinglePionHCALUp[25];   //[nJet]
   Float_t         Jet_corr_SinglePionHCALDown[25];   //[nJet]
   Float_t         Jet_corr_FlavorQCDUp[25];   //[nJet]
   Float_t         Jet_corr_FlavorQCDDown[25];   //[nJet]
   Float_t         Jet_corr_TimePtEtaUp[25];   //[nJet]
   Float_t         Jet_corr_TimePtEtaDown[25];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC1Up[25];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC1Down[25];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC2Up[25];   //[nJet]
   Float_t         Jet_corr_RelativeJEREC2Down[25];   //[nJet]
   Float_t         Jet_corr_RelativeJERHFUp[25];   //[nJet]
   Float_t         Jet_corr_RelativeJERHFDown[25];   //[nJet]
   Float_t         Jet_corr_RelativePtBBUp[25];   //[nJet]
   Float_t         Jet_corr_RelativePtBBDown[25];   //[nJet]
   Float_t         Jet_corr_RelativePtEC1Up[25];   //[nJet]
   Float_t         Jet_corr_RelativePtEC1Down[25];   //[nJet]
   Float_t         Jet_corr_RelativePtEC2Up[25];   //[nJet]
   Float_t         Jet_corr_RelativePtEC2Down[25];   //[nJet]
   Float_t         Jet_corr_RelativePtHFUp[25];   //[nJet]
   Float_t         Jet_corr_RelativePtHFDown[25];   //[nJet]
   Float_t         Jet_corr_RelativeBalUp[25];   //[nJet]
   Float_t         Jet_corr_RelativeBalDown[25];   //[nJet]
   Float_t         Jet_corr_RelativeFSRUp[25];   //[nJet]
   Float_t         Jet_corr_RelativeFSRDown[25];   //[nJet]
   Float_t         Jet_corr_RelativeStatFSRUp[25];   //[nJet]
   Float_t         Jet_corr_RelativeStatFSRDown[25];   //[nJet]
   Float_t         Jet_corr_RelativeStatECUp[25];   //[nJet]
   Float_t         Jet_corr_RelativeStatECDown[25];   //[nJet]
   Float_t         Jet_corr_RelativeStatHFUp[25];   //[nJet]
   Float_t         Jet_corr_RelativeStatHFDown[25];   //[nJet]
   Float_t         Jet_corr_PileUpDataMCUp[25];   //[nJet]
   Float_t         Jet_corr_PileUpDataMCDown[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtRefUp[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtRefDown[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtBBUp[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtBBDown[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC1Up[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC1Down[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC2Up[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtEC2Down[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtHFUp[25];   //[nJet]
   Float_t         Jet_corr_PileUpPtHFDown[25];   //[nJet]
   Float_t         Jet_corr_PileUpMuZeroUp[25];   //[nJet]
   Float_t         Jet_corr_PileUpMuZeroDown[25];   //[nJet]
   Float_t         Jet_corr_PileUpEnvelopeUp[25];   //[nJet]
   Float_t         Jet_corr_PileUpEnvelopeDown[25];   //[nJet]
   Float_t         Jet_corr_SubTotalPileUpUp[25];   //[nJet]
   Float_t         Jet_corr_SubTotalPileUpDown[25];   //[nJet]
   Float_t         Jet_corr_SubTotalRelativeUp[25];   //[nJet]
   Float_t         Jet_corr_SubTotalRelativeDown[25];   //[nJet]
   Float_t         Jet_corr_SubTotalPtUp[25];   //[nJet]
   Float_t         Jet_corr_SubTotalPtDown[25];   //[nJet]
   Float_t         Jet_corr_SubTotalScaleUp[25];   //[nJet]
   Float_t         Jet_corr_SubTotalScaleDown[25];   //[nJet]
   Float_t         Jet_corr_SubTotalAbsoluteUp[25];   //[nJet]
   Float_t         Jet_corr_SubTotalAbsoluteDown[25];   //[nJet]
   Float_t         Jet_corr_SubTotalMCUp[25];   //[nJet]
   Float_t         Jet_corr_SubTotalMCDown[25];   //[nJet]
   Float_t         Jet_corr_TotalUp[25];   //[nJet]
   Float_t         Jet_corr_TotalDown[25];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorUp[25];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorDown[25];   //[nJet]
   Float_t         Jet_corr_TotalNoTimeUp[25];   //[nJet]
   Float_t         Jet_corr_TotalNoTimeDown[25];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorNoTimeUp[25];   //[nJet]
   Float_t         Jet_corr_TotalNoFlavorNoTimeDown[25];   //[nJet]
   Float_t         Jet_corr_FlavorZJetUp[25];   //[nJet]
   Float_t         Jet_corr_FlavorZJetDown[25];   //[nJet]
   Float_t         Jet_corr_FlavorPhotonJetUp[25];   //[nJet]
   Float_t         Jet_corr_FlavorPhotonJetDown[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureGluonUp[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureGluonDown[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureQuarkUp[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureQuarkDown[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureCharmUp[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureCharmDown[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureBottomUp[25];   //[nJet]
   Float_t         Jet_corr_FlavorPureBottomDown[25];   //[nJet]
   Float_t         Jet_corr_TimeRunBCDUp[25];   //[nJet]
   Float_t         Jet_corr_TimeRunBCDDown[25];   //[nJet]
   Float_t         Jet_corr_TimeRunEFUp[25];   //[nJet]
   Float_t         Jet_corr_TimeRunEFDown[25];   //[nJet]
   Float_t         Jet_corr_TimeRunGUp[25];   //[nJet]
   Float_t         Jet_corr_TimeRunGDown[25];   //[nJet]
   Float_t         Jet_corr_TimeRunHUp[25];   //[nJet]
   Float_t         Jet_corr_TimeRunHDown[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupMPFInSituUp[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupMPFInSituDown[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupIntercalibrationUp[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupIntercalibrationDown[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupbJESUp[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupbJESDown[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupFlavorUp[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupFlavorDown[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupUncorrelatedUp[25];   //[nJet]
   Float_t         Jet_corr_CorrelationGroupUncorrelatedDown[25];   //[nJet]
   ...
   Int_t           GenGluonFromTop_pdgId[1];   //[nGenGluonFromTop]
   Float_t         GenGluonFromTop_pt[1];   //[nGenGluonFromTop]
   Float_t         GenGluonFromTop_eta[1];   //[nGenGluonFromTop]
   Float_t         GenGluonFromTop_phi[1];   //[nGenGluonFromTop]
   Float_t         GenGluonFromTop_mass[1];   //[nGenGluonFromTop]
   Float_t         GenGluonFromTop_charge[1];   //[nGenGluonFromTop]
   Int_t           GenGluonFromTop_status[1];   //[nGenGluonFromTop]
   Int_t           GenGluonFromTop_isPromptHard[1];   //[nGenGluonFromTop]
   Int_t           nsoftActivityJets;
   Float_t         softActivityJets_pt[10];   //[nsoftActivityJets]
   Float_t         softActivityJets_eta[10];   //[nsoftActivityJets]
   Float_t         softActivityJets_phi[10];   //[nsoftActivityJets]
   Float_t         softActivityJets_mass[10];   //[nsoftActivityJets]
   ...
   Int_t           ntrgObjects_hltSingleJet80;
	Float_t 			Jet_blikelihood_b[25];
	Float_t 			Jet_pt_regNew[25];
 ...
 TBranch        *b_run;   //!
   ...
   TBranch        *b_ntrgObjects_hltSingleJet80;   //!
	TBranch 			*b_Jet_blikelihood_b;
	TBranch 			*b_Jet_pt_regNew;




   CreateTree_Zbb(TTree *tree=0, TString filename="");
   virtual ~CreateTree_Zbb();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString file_tag="", TString output="", int sel_type=0);
...
#ifdef CreateTree_Zbb_cxx
CreateTree_Zbb::CreateTree_Zbb(TTree *tree, TString filename) : fChain(0) 
{
...
CreateTree_Zbb::~CreateTree_Zbb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CreateTree_Zbb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CreateTree_Zbb::LoadTree(Long64_t entry)
{
...
void CreateTree_Zbb::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Jet_pt_regNew", Jet_pt_regNew, &b_Jet_pt_regNew);

   Notify();
}

Bool_t CreateTree_Zbb::Notify()
{
...
void CreateTree_Zbb::Show(Long64_t entry)
{
...
Int_t CreateTree_Zbb::Cut(Long64_t entry)
{
...
#endif // #ifdef CreateTree_Zbb_cxx
