...
export MYBATCHDIR=/mnt/t3nfs01/data01/shome/nchernya/VBFHbb2016/Zbb_fit/bias/toys/expPow/
cd $MYBATCHDIR

combine -M GenerateOnly --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND --X-rtd ADDNLL_RECURSIVE=0 --X-rtd FITTER_NEW_CROSSING_ALGO --toysFrequentist -t $1 --expectSignal $2 --saveToys  --rMin=-3 --rMax=3 -n $3 -s -1  $4
