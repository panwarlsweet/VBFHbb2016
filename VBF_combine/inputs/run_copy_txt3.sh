...
path=root://t3dcachedb.psi.ch:1094///pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFHbb2016/v25_VBF_mva_JESR_full/
...
max_files=11 #15 #15 #28  #9+8 
pre=VBFMvaJESR_v25_weights_new
while [ $current_file -lt $max_files  ]
do	 
	xrdcp $path/double$pre${file_name[$current_file]}.root  /afs/cern.ch/work/n/nchernya/VBFHbb_2016/VBF_combine/inputs/root_unc/
