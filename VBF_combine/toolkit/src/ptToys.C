...
void ptToys(float BIN_SIZE=5.0,bool BLIND=false,TString MASS="125",TString NAME="",TString saveNAME="")
{
 // gROOT->ProcessLine(".x ../../common/styleCMSTDR.C");
  ...
  TFile *f2 = TFile::Open("test_Signal/run_from/mlfitfixedto1.root");
...
//  TFile *f1 = TFile::Open("zjets/datacards/datacard_vbfHbb_names_m125.root");
 // TFile *f2 = TFile::Open("zjets/run_from/mlfit.root");
//  TFile *f3 = TFile::Open("zjets/root/sig_shapes_workspace_2016.root");
//  TFile *f4 = TFile::Open("zjets/root/data_shapes_workspace_2016.root");
