...
####fdata = ROOT.TFile.Open("/afs/cern.ch/work/n/nchernya/VBFHbb_2016/VBF_combine/toolkit/src/combination/run_v9/mlfitnormal_fit_v9_Freq_shapes.root")  ##asimov
...
#	all_hists.append(main_hist)
	...
	leg.Draw()
	c.SaveAs("toys_fit_nolimit_accum_cat%d.png"%cat)
