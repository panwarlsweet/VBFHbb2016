...
####### from 0,300 BRN
fdata_fit = ROOT.TFile.Open("/afs/cern.ch/work/n/nchernya/VBFHbb_2016/VBF_combine/toolkit/src/nolimit/run_from/mlfitfitToData.root")
fAsimov = ROOT.TFile.Open("/afs/cern.ch/work/n/nchernya/VBFHbb_2016/VBF_combine/toolkit/src/nolimit/run_from/mlfitfitToDataAsimov.root")
#############freeze QCD###################
...
for i in range(0,100):
	...
	files.append("/afs/cern.ch/work/n/nchernya/VBFHbb_2016/VBF_combine/toolkit/src/nolimit/toys_Fit/all_toys_noopt/mlfitnoopt_2_num_%d.root"%i)
	##########freeeze QCD##########
...
#	data_fit.SetMarkerColor(ROOT.kRed)
	...
	leg.Draw()
	c.SaveAs("plot/toys_fit_nolimit_noopt_bg_accum_cat%d.png"%cat)
