...
#ifndef CreateTree_b1_h
#define CreateTree_b1_h
...
public :
 ...
 UInt_t          run;
   ...
   Int_t           GenBQuarkFromHafterISR_pdgId[3];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_pt[3];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_eta[3];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_phi[3];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_mass[3];   //[nGenBQuarkFromHafterISR]
   Float_t         GenBQuarkFromHafterISR_charge[3];   //[nGenBQuarkFromHafterISR]
   Int_t           GenBQuarkFromHafterISR_status[3];   //[nGenBQuarkFromHafterISR]
   Int_t           GenBQuarkFromHafterISR_isPromptHard[3];   //[nGenBQuarkFromHafterISR]
   ...
   Int_t           selLeptons_mediumIdPOG_ICHEP2016[4];   //[nselLeptons]
   ...
   Float_t         selLeptons_relIsoAn04[4];   //[nselLeptons]
   ...
   Int_t           selLeptons_convVetoFull[4];   //[nselLeptons]
   Float_t         selLeptons_eleMVArawSpring15Trig[4];   //[nselLeptons]
   ...
   Float_t         selLeptons_mvaTTHjetPtRatio[4];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetBTagCSV[4];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetDR[4];   //[nselLeptons]
   ...
   Float_t         selLeptons_dr03TkSumPt[4];   //[nselLeptons]
   Float_t         selLeptons_eleEcalClusterIso[4];   //[nselLeptons]
   Float_t         selLeptons_eleHcalClusterIso[4];   //[nselLeptons]
   Float_t         selLeptons_miniIsoCharged[4];   //[nselLeptons]
   Float_t         selLeptons_miniIsoNeutral[4];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetPtRel[4];   //[nselLeptons]
   Float_t         selLeptons_mvaTTHjetNDauChargedMVASel[4];   //[nselLeptons]
   Float_t         selLeptons_uncalibratedPt[4];   //[nselLeptons]
   Float_t         selLeptons_SF_IsoLoose[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IsoLoose[4];   //[nselLeptons]
   Float_t         selLeptons_SF_IsoTight[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IsoTight[4];   //[nselLeptons]
   Float_t         selLeptons_SF_IdCutLoose[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdCutLoose[4];   //[nselLeptons]
   Float_t         selLeptons_SF_IdCutTight[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdCutTight[4];   //[nselLeptons]
   Float_t         selLeptons_SF_IdMVALoose[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdMVALoose[4];   //[nselLeptons]
   Float_t         selLeptons_SF_IdMVATight[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdMVATight[4];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunD4p3[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunD4p3[4];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunD4p2[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunD4p2[4];   //[nselLeptons]
   Float_t         selLeptons_SF_HLT_RunC[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT_RunC[4];   //[nselLeptons]
   Float_t         selLeptons_SF_trk_eta[4];   //[nselLeptons]
   Float_t         selLeptons_SFerr_trk_eta[4];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunD4p3[4];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunD4p3[4];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunD4p2[4];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunD4p2[4];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT_RunC[4];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT_RunC[4];   //[nselLeptons]
 ...
 TBranch        *b_run;   //!
   ...
   CreateTree_b1(TTree *tree=0, TString filename="");
   virtual ~CreateTree_b1();
...
#ifdef CreateTree_b1_cxx
CreateTree_b1::CreateTree_b1(TTree *tree, TString filename) : fChain(0) 
{
...
CreateTree_b1::~CreateTree_b1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CreateTree_b1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CreateTree_b1::LoadTree(Long64_t entry)
{
...
void CreateTree_b1::Init(TTree *tree)
{
...
void CreateTree_b1::Show(Long64_t entry)
{
...
Int_t CreateTree_b1::Cut(Long64_t entry)
{
