...
//void TMVAGui( const char* fName = "/mnt/t3nfs01/data01/shome/nchernya/VBFZll/main_mva/output/v24/TMVA_main_v24_Nm1_allmu_8var_opt.root" )
void TMVAGui( const char* fName = "/mnt/t3nfs01/data01/shome/nchernya/VBFHbb2016/Zbb_mva/output/v25/TMVA_main_v25_Nm1_alldoubleFisherTry1.root")
//void TMVAGui( const char* fName = "output/v21/TMVA_main_v21_Data_Nm1_all_woPhiQQ.root" )
...
{   
   ...
   while ((str = (TObjString*)it())) {
	...
	//	cout<<fName<<" , "<<str->GetString().Data()<<"  , "<<title.Data()<<endl;
                    cout<<Form( ".x ../variables.C(\"%s\",\"%s\",\"%s\")", fName, str->GetString().Data(), title.Data() )<<endl;
   }      
   ic++;
