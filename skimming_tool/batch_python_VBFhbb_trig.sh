...
mkdir $TMPDIR/$2
echo $1 $TMPDIR/$2 $3 
./run_vbfhbb_trig $1 $TMPDIR/$2 $3

xrdfs t3se01.psi.ch mkdir -p /store/user/nchernya/VBFHbb2016/triggers/v25/QuadVBF/$2

#xrdfs t3se01.psi.ch rm  /store/user/nchernya/VBFHbb2016/triggers/v25/$2/skimmed_tree_$1.root

xrdcp -f $TMPDIR/$2/skimmed_tree_$1.root  root://t3dcachedb.psi.ch:1094//pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFHbb2016/triggers/v25/QuadVBF/$2/
