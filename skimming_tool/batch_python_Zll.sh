...
xrdfs t3se01.psi.ch mkdir -p /store/user/nchernya/VBFZll/workflow/v25_reskim/$2

#xrdfs t3se01.psi.ch rm  /store/user/nchernya/VBFZll/workflow/v25_reskim/$2/skimmed_tree_$1.root

#xrdcp $TMPDIR/$2/skimmed_tree_$1.root root://t3se01.psi.ch//store/user/nchernya/VBFZll/workflow/v25_reskim/$2/
xrdcp -f $TMPDIR/$2/skimmed_tree_$1.root  root://t3dcachedb.psi.ch:1094//pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFZll/workflow/v25_reskim/$2/
